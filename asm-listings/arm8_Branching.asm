...
@ src/atomic/workloads/Branching.cpp -mfloat-abi=soft -marm -march=armv8-a
@ -auxbase-strip asm-listings/arm8_Branching.asm -Werror -Wall -std=c++17
...
.LFB881:
	...
	sub	sp, sp, #8	@,,
	str	r0, [fp, #-8]	@ __x, __x
@ /opt/gcc-arm-none-eabi-8-2018-q4-major/arm-none-eabi/include/c++/8.2.1/cmath:476:     { return __builtin_sqrt(__x); }
	ldr	r0, [fp, #-8]	@, __x
	bl	__aeabi_i2d		@
	mov	r2, r0	@ _1,
	mov	r3, r1	@ _1,
