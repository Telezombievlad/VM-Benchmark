...
@ -D__USES_INITFINI__ src/workloads/VectorArithm.cpp -march=armv8-a
@ -auxbase-strip asm-listings/arm8_VectorArithm.asm -Werror -Wall
...
.LFB0:
	...
	str	fp, [sp, #-4]!	@,
	add	fp, sp, #0	@,,
@ src/workloads/VectorArithm.cpp:78: }
	nop
	add	sp, fp, #0	@,,
	@ sp needed	@
	ldr	fp, [sp], #4	@,
